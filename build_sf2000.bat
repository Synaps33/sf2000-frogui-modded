...
REM ========================================
REM  FrogUI Build Script for SF2000
REM ========================================
...
wsl bash -c "cd '!WSL_PATH!' && make clean CORE=cores/menu FROGGY_TYPE=SF2000 && make CORE=cores/menu FROGGY_TYPE=SF2000 CONSOLE=menu"
