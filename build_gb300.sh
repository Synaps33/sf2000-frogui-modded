...
# ========================================
#  FrogUI Build Script for GB300 (Linux / WSL)
# ========================================
...
cd "$MULTICORE_DIR"
make clean CORE=cores/menu FROGGY_TYPE=GB300V2
make CORE=cores/menu FROGGY_TYPE=GB300V2 CONSOLE=menu

cp "$MULTICORE_DIR/core_87000000" "$SCRIPT_DIR/core_87000000_gb300"

echo ""
echo "========================================"
echo " BUILD SUCCESSFUL!"
echo " Output: $SCRIPT_DIR/core_87000000_gb300"
echo " Size: $(ls -lh "$SCRIPT_DIR/core_87000000_gb300" | awk '{print $5}')"
echo "========================================"
